...
public class PersonManager {
    ...
    public static void selectAddress(SqlSession sqlSession) {
        ...
        var addr = addrMapper.getAddress(2);
        System.out.println(addr.getDetail());
        // 访问关联实体
        System.out.println(addr.getDetail() + "的主人:" + addr.getOwner());
        System.out.println(addr.getDetail() + "的租客:" + addr.getRenter());
        // 提交事务
        sqlSession.commit();
        // 关闭资源
        sqlSession.close();
    ...
    public static void selectPerson(SqlSession sqlSession) {
        ...
        personList.forEach(person -> {
            // 访问Person实体及其关联实体的属性
            System.out.println(person.getName() + "领地:"
                    + person.getOwnerAddr().getDetail());
            System.out.println(person.getName() + "租赁地:"
                    + person.getRentalAddr().getDetail());
        });
        // 提交事务
        sqlSession.commit();
        // 关闭资源
